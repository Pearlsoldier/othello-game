...
class Player:
    ...
    def omnidirectional_flip(self, column, row, board, current_color, opposite_color):
        self.flip_turn_directly_above(
            column, row, board, current_color, opposite_color
        ),
        self.flip_turn_directly_below(
            column, row, board, current_color, opposite_color
        ),
    ...
    def flip_turn_directly_above(
        self, column, row, board, current_color, opposite_color
    ):
        rules = Rule()
        if rules.is_flippable_line_directly_above(
    ...
    def flip_turn_right(self, column, row, board, current_color, opposite_color):
        rules = Rule()
        if rules.is_flippable_line_right(
            row, column, board, opposite_color, current_color
        ):
            i = 1
    ...
    def flip_turn_directly_below(
        self, column, row, board, current_color, opposite_color
    ):
        rules = Rule()
        if rules.is_flippable_line_directly_below(
            row, column, board, opposite_color, current_color
        ):
            i = 1
            while board.row[row + i][column] == opposite_color:
    ...
    def flip_turn_left(self, column, row, board, current_color, opposite_color):
        rules = Rule()
        if rules.is_flippable_line_left(
            row, column, board, opposite_color, current_color
        ):
            i = 1
            while board.row[row][column - i] == opposite_color:
    ...
    def flip_turn_lower_right(self, column, row, board, current_color, opposite_color):
        rules = Rule()
        if rules.is_flippable_line_lower_right(
            row, column, board, opposite_color, current_color
        ):
            i = 1
    ...
    def flip_turn_upper_left(self, column, row, board, current_color, opposite_color):
        rules = Rule()
        if rules.is_flippable_line_upper_left(
            row, column, board, opposite_color, current_color
        ):
            i = 1
            while board.row[row - i][column - i] == opposite_color:
    ...
    def flip_turn_upper_righ(self, column, row, board, current_color, opposite_color):
        rules = Rule()
        if rules.is_flippable_line_upper_right(
            row, column, board, opposite_color, current_color
        ):
            i = 1
            while board.row[row - i][column + i] == opposite_color:
    ...
    def flip_turn_lower_left(self, column, row, board, current_color, opposite_color):
        rules = Rule()
        if rules.is_flippable_line_lower_left(
            row, column, board, opposite_color, current_color
        ):
            i = 1
            while board.row[row + i][column - i] == opposite_color:
